<?php
/*
Plugin Name: Ahuimanu Darksky Weather
Plugin URI: http://github.com/ahuimanu/AhuimanuDarkSkyWeather
...
function ahuimanu_darksky_weather_create_widgets() {
	register_widget( 'Ahuimanu_DarkySky_Weather' );
}

class Ahuimanu_DarkySky_Weather extends WP_Widget {
	// Construction function
	function __construct () {
		parent::__construct( 'Ahuimanu_DarkySky_Weather', 'DarkSky Weather',
			array( 'description' =>
	...
	function widget( $args, $instance ) {
       ...
       // echo date("l jS \of F Y h:i:s A", intval($data_darksky['currently']['time'])) . " UTC";
		...
		//echo '<br>';
		echo '<br>';
		echo "Summary: " . $data_darksky['daily']['summary'];
		echo '<br>';
       // echo "Alerts: " . $data_darksky['alerts']['title'];
		//echo '<br>';
        echo $after_widget;
	}
}
